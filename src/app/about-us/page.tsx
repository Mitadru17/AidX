  ...
  return (
    <div className={`min-h-screen bg-white transition-opacity duration-500 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <nav className={`py-4 px-6 flex justify-between items-center fixed w-full z-50 transition-all duration-300 bg-white/90 backdrop-blur-sm shadow-md`}>
        ...
        <div className="flex items-center gap-6">
          ...
          <SignInButton afterSignInUrl="/select-role">
            <button className="px-4 py-2 rounded-lg hover:shadow-md transition-all duration-300 bg-white text-blue-700 border-2 border-blue-600 hover:-translate-y-0.5 transform">
              Login
            </button>
          </SignInButton>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        {/* Doctor Info Section */}
        <div className="mb-16 animate-fadeIn" style={{ animationDuration: '1s' }}>
          <span className="inline-block px-3 py-1 mb-4 text-blue-600 bg-blue-50 rounded-full text-sm font-medium">Meet Our Doctor</span>
          <div className="flex flex-col md:flex-row items-start gap-12">
            <div className="flex-1">
              <h1 className="text-4xl font-bold mb-6 leading-tight">Dr. Neha Sharma, <span className="bg-gradient-to-r from-cyan-600 to-blue-700 bg-clip-text text-transparent">MBBS</span></h1>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                Dr. Neha has been a dedicated member of The Community College health services for the past five years. Highly regarded by her patients, she routinely attends to over 30 individuals daily and is a well-known and trusted figure within the local community.
              </p>
            ...
            <div className="w-full md:w-2/5 animate-slideInRight" style={{ animationDuration: '1s', animationDelay: '0.2s', animationFillMode: 'both' }}>
        ...
        <div id="contact" className="max-w-2xl mx-auto animate-slideInUp" style={{ animationDuration: '1s', animationDelay: '0.4s', animationFillMode: 'both' }}>
          <div className="text-center max-w-xl mx-auto mb-12">
            <span className="inline-block px-3 py-1 mb-4 text-blue-600 bg-blue-50 rounded-full text-sm font-medium">Get In Touch</span>
            <h2 className="text-3xl font-bold mb-4">Contact us</h2>
            <p className="text-gray-600">Have questions or need to schedule an appointment? Reach out to us using the form below.</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-3 rounded-lg border border-gray-300 shadow-sm focus:border-blue-600 focus:ring-blue-600 transition-all duration-300"
              ...
              <div>
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-700 text-white rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 transform flex items-center justify-center"
                >
